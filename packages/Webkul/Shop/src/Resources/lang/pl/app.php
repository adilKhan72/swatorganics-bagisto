...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Prawa autorskie 2010 - :current_year, Swat Organics (zarejestrowane w Indiach). Wszelkie prawa zastrzeżone.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Prawa autorskie 2010 - :current_year, Swat Organics (zarejestrowane w Indiach). Wszelkie prawa zastrzeżone.',
                'locale'                 => 'Lokalizacja',
