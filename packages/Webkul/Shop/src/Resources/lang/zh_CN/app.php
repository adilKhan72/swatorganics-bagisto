...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© 版权所有 2010 - :current_year，Swat Organics（注册于印度）。保留所有权利。',
        ...
        'reset-password' => [
            ...
            'email'            => '注册电子邮件',
            'footer'           => '© 版权 2010 - :current_year，Swat Organics（注册于印度）。保留所有权利。',
            'password'         => '密码',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'email'                  => '电子邮件',
                'footer-content'         => '页脚内容',
                'footer-text'            => '© 版权所有 2010 - :current_year，Swat Organics（印度注册）。保留所有权利。',
                'locale'                 => '语言',
