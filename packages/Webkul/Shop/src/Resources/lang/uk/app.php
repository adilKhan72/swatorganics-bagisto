...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Копірайт 2010 - :current_year, Swat Organics (зареєстрована в Індії). Всі права захищені.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Авторське право 2010 - :current_year, Swat Organics (зареєстровано в Індії). Усі права захищені.',
                'locale'                 => 'Мова',
