...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright 2023 - :current_year, Swat Organics (in Indien registriert). Alle Rechte vorbehalten.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Copyright 2023 - :current_year, Swat Organics (eingetragen in Indien). Alle Rechte vorbehalten.',
                'locale'                 => 'Sprache',
